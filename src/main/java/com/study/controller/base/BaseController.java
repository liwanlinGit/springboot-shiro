...
public class BaseController {
  ...
  @RequestMapping(value="/page/{path}/{menuName}",method={RequestMethod.GET})
  public String page(@PathVariable String path,@PathVariable String menuName,HttpServletRequest request){
